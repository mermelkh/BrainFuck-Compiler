...
class ProgramTest {
    ...
    void main_with_nested_loops_HelloWorld() {
        Main main = new Main();
        String str=  "++++++++[>++++[>++>+++>+++>+<<<<-]>+>+>->>+[<]<-]>>.>---.+++++++..+++.>>.<-.<.+++.------.--------.>>+.>++.";
    ...
    @org.junit.jupiter.api.Test
    void main_str_with_loops_Hellowirld() {
        Main main = new Main();
        String str=">+++++++++[<++++++++>-]<.>+++++++[<++++>-]<+.+++++++..+++.[-]" +
                ">++++++++[<++++>-]<.>+++++++++++[<++++++++>-]<-.--------.+++" +
                ".------.--------.[-]>++++++++[<++++>-]<+.[-]++++++++++.";
    ...
    @org.junit.jupiter.api.Test
    void main_with_nested_loops_OK() {
    ...
    @org.junit.jupiter.api.Test
    void main_with_nested_loops_dead_code_Zombie() {
        Main main = new Main();
        String str = "[-]>[-]>[-]<++[>++++++++<-]>[<++++++++>-]<[>++++++++<-]>[<++++++++>-" +
                "]<[<++++++++>-]<[[-]>[-]+++++++++[<++++++++++>-]<.>++++[<+++++>-]<+." +
                "--.-----------.+++++++.----.>>[-]<+++++[>++++++<-]>++.<<[-]]";
